...
public class Estacionamento {
	...
	public static Calendar perguntarHorarioEntrada() {
		...
		calendarioHorarioEntrada.set(Calendar.HOUR_OF_DAY,
				Integer.parseInt(digiteString("\nHorario de Entrada do veiculo ->")));

		calendarioHorarioEntrada.set(Calendar.MINUTE,
				Integer.parseInt(digiteString("\nOs minutos -> ")));

		calendarioHorarioEntrada.set(Calendar.SECOND, 
				Integer.parseInt(digiteString("\nOs segundos -> ")));
	...
	public static Calendar perguntarHorarioSaida() {
		...
		calendarioHorarioSaida.set(Calendar.HOUR_OF_DAY,
				Integer.parseInt(digiteString("\nHorario de Saida do veiculo -> ")));

		calendarioHorarioSaida.set(Calendar.MINUTE,
				Integer.parseInt(digiteString("\nOs minutos -> ")));

		calendarioHorarioSaida.set(Calendar.SECOND,
				Integer.parseInt(digiteString("\nOs segundos -> ")));
	...
	public void entrarEstacionamento(List<Vaga>vagas) {
